    ...
    return [
      {
        ...
        titulo: "Venha ter uma nova experiência",
        subTitulo: "Dê seus primeiros passos para começar a mergulhar e conheça esse mundo de aventuras.",
        textoBotao: "Comece a mergulhar agora"
      },
      {
